...
managerUI::managerUI(Service& service): managerService{service}
{
...
void managerUI::showAllDogs() {
	if (this->managerService.getSizeForDogsNotAddopted() == 0 && this->managerService.getSizeForDogsAddopted() == 0) throw Exceptions().dogsNotFound();
	cout << endl;
